...
contract DocSmartContract3 {
    ...
    struct Request{
       ...
       mapping (address => uint[]) reqid;
     mapping (address => Request) requests;
     address[] public requestAccts;
    
    function setRequest(address _address, uint _reqid, string _req, string _Type) public {
        ...
        function getRequest(address _address, uint _reqid) view public returns (string, string) {
